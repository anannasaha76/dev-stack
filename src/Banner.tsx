            ...
            <div className="max-w-[1200px] mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-8 md:gap-10">
                <div className="flex flex-col items-center text-center md:items-start md:text-left max-w-[480px] w-full">
                    ...
                    <div className="flex items-center justify-center md:justify-start gap-3 flex-wrap">
                       <button className="w-[220px] bg-linear-to-r from-[#F97316] to-[#EC4899] text-white font-semibold text-sm md:text-base px-7 py-2.5 md:py-3 rounded-lg shadow-lg transition-opacity">
                             Explore Technologies
                      </button>

                      <button className="w-[220px] text-[#374151] font-semibold text-sm md:text-base px-7 py-2.5 md:py-3 rounded-lg border border-[#D1D5DB] transition-colors">
                           Learn More
                      </button>
                    </div>
                </div>
